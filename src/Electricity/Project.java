...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String meter, String person){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("icon/Logo-msebc.jpg"));
        Image i3 = ic.getImage().getScaledInstance(1400, 600,Image.SCALE_DEFAULT);
        ...
        JMenu master = new JMenu("Activity");
        JMenuItem m1 = new JMenuItem("New Customer");
        JMenuItem m2 = new JMenuItem("Customer Details");
        JMenuItem m3 = new JMenuItem("Deposit Details");
        JMenuItem m4 = new JMenuItem("Calculate Bill");
        master.setForeground(Color.BLUE);
        master.setFont(new Font("Jost",Font.PLAIN,18));
        
        
        /* ---- Customer Details ---- */
        m1.setFont(new Font("Jost",Font.PLAIN,16));
        ...
        /* ---- Meter Details ---- */
        m2.setFont(new Font("Jost",Font.PLAIN,16));
        ...
        m2.setBackground(Color.WHITE);
         ...
         /* ---- Deposit Details  ----- */
        m3.setFont(new Font("Jost",Font.PLAIN,16));
        ...
        m4.setFont(new Font("Jost",Font.PLAIN,16));
        ...
        info.setFont(new Font("Jost",Font.PLAIN,18));
        info.setForeground(Color.BLUE);
        
        /* ---- Pay Bill ---- */
        info1.setFont(new Font("Jost",Font.PLAIN,16));
        ...
        /* ---- Last Bill ----*/
        info2.setFont(new Font("Jost",Font.PLAIN,16));
        ...
        user.setFont(new Font("Jost",Font.PLAIN,18));
        
        
        /* ---- Pay Bill ---- */
        u1.setFont(new Font("Jost",Font.PLAIN,16));
        ...
        /* ---- Last Bill ----*/
        u3.setFont(new Font("Jost",Font.PLAIN,16));
        ...
        report.setFont(new Font("Jost",Font.PLAIN,18));
        
        /* ---- Report ---- */
        r1.setFont(new Font("Jost",Font.PLAIN,16));
        ...
        utility.setFont(new Font("Jost",Font.PLAIN,18));
        
        /* ---- Calender ---- */
        ut1.setFont(new Font("Jost",Font.PLAIN,16));
        ...
        /* ---- Calculator ---- */
        ut2.setFont(new Font("Jost",Font.PLAIN,16));
        ...
        /* ---- Web Browser ---- */
//        ut3.setFont(new Font("Jost",Font.PLAIN,16));
...
//        ut3.addActionListener(this);
        ...
        exit.setFont(new Font("Jost",Font.PLAIN,18));
        
        
        /* ---- Exit ---- */
        ex.setFont(new Font("Jost",Font.PLAIN,16));
        ...
        setFont(new Font("Jost",Font.BOLD,16));
